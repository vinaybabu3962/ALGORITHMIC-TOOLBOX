...
<center>
<span style="background-image:linear-gradient(to right, #6db9ef, #7ce08a);color:black;" class="badge badge-pill badge-success"><h3>TRAVELLING SALESMAN PROBLEM</h3></span>
<br><br>
 <% int s=(int)request.getAttribute("cost");
 int[] cost=(int[])request.getAttribute("finalpath") ;%>
 <b>Minimum cost to go  from source to destination is:</b><%=s %>
 <br><br>
 <b><u>Path to go from source to destination is:</u></b>
 <br>
 <h4>
